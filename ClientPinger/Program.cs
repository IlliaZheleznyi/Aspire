...
var connection = new HubConnectionBuilder()
    .WithUrl("https://localhost:7200/chathub?userId=User1", options =>
    {
...
await connection.InvokeAsync("Subscribe", "User1", 0);
Console.WriteLine("Sent subscription for metric 0 (TimeRate)");
